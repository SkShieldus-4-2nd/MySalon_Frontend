...
export const DivWrapper = () => {
  ...
  const menuItems = ["내 주문 내역", "찜한 상품", "장바구니", "나의 리뷰"];
    ...
    <div className="bg-[#f1f1f1] min-h-screen w-full">
      <div className="max-w-[1440px] mx-auto relative">
        ...
        <nav className="flex justify-end pt-[33px] pr-[127px]">
          <div className="[font-family:'Crimson_Text',Helvetica] font-normal text-black text-[15px] tracking-[0] leading-[21px]">
        ...
        <div className="absolute top-[67px] right-[37px] w-[296px]">
          <div className="relative">
            <Input
              placeholder="Search"
              className="w-full h-16 pl-12 pr-12 bg-[#78788029] border-none rounded-[100px] [font-family:'SF_Pro-Regular',Helvetica] text-[17px] text-[#999999] placeholder:text-[#999999]"
            />
